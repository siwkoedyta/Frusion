...
public interface Json {
    record Transaction(String id, String clientId, double weightGross, String boxId, int numberOfBoxes, LocalDate transactionDate, double weightNet, BigDecimal amount, BigDecimal price, String fruitId) {
    }
